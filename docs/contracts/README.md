...
| [`TCC-LEASE-CONFIG`](target-config-contract.md#TCC-LEASE-CONFIG), [`TCC-ONBOARDING`](target-config-contract.md#TCC-ONBOARDING), [`TCC-AGENT-RUNNER-MAP`](target-config-contract.md#TCC-AGENT-RUNNER-MAP) | [`lease-and-recovery.md`](../architecture/lease-and-recovery.md), [`agent-runner-adapters.md`](../architecture/agent-runner-adapters.md) |
