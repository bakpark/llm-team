...
| 문서 | 책임 |
|---|---|
| `agent-and-context-contract.md` | Agent 역할, Context Manifest, revision pin, output envelope, role별 산출 계약 |
| `state-and-operation-contract.md` | Milestone / Task / Change Proposal 상태, 허용 전이, operation별 Caller action |
| `reliability-and-gate-contract.md` | lease, retry, stale recovery, deterministic verification, human gate, transition ledger, pause |
| `knowledge-contract.md` | 누적 스펙, manifest, decision log, context summary, AC traceability |
